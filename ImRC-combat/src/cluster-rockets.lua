...
local cluster_rocket_ammo = {
    type = "ammo",
    name = "cluster-rocket",
    icon = "__ImRC-combat__/graphics/icons/micromissile-pack.png",
    subgroup = "ammo",
    ammo_category = "rocket",
    order = "d[rocket-launcher]-e[cluster-rocket]",
    inventory_move_sound = data.raw["ammo"]["rocket"].inventory_move_sound,
    pick_sound = data.raw["ammo"]["rocket"].pick_sound,
    drop_sound = data.raw["ammo"]["rocket"].drop_sound,
    stack_size = 100,
    magazine_size = 3,
...
local cluster_rocket_ex_ammo = {
    ...
    icon = "__ImRC-combat__/graphics/icons/micromissile-explosive-pack.png",
    subgroup = "ammo",
    ammo_category = "rocket",
...
local cluster_rocket_tech = {
    ...
    icon_size = 256,
    icon = "__ImRC-combat__/graphics/technology/mass-rocketry.png",
