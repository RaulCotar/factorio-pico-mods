local t2w_ent = table.deepcopy(data.raw["wall"]["stone-wall"])
t2w_ent.name = "t2wall"
...
t2w_ent.pictures = {
  single =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-single.png",
        priority = "extra-high",
        width = 64,
        height = 86,
        variation_count = 2,
  ...
  straight_vertical =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-vertical.png",
        priority = "extra-high",
        width = 64,
        height = 134,
        variation_count = 5,
  ...
  straight_horizontal =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-horizontal.png",
        priority = "extra-high",
        width = 64,
        height = 92,
        variation_count = 6,
  ...
  corner_right_down =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-corner-right.png",
        priority = "extra-high",
        width = 64,
        height = 128,
        variation_count = 2,
  ...
  corner_left_down =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-corner-left.png",
        priority = "extra-high",
        width = 64,
        height = 134,
        variation_count = 2,
  ...
  t_up =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-t.png",
        priority = "extra-high",
        width = 64,
        height = 134,
        variation_count = 4,
  ...
  ending_right =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-ending-right.png",
        priority = "extra-high",
        width = 64,
        height = 92,
        variation_count = 2,
  ...
  ending_left =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-ending-left.png",
        priority = "extra-high",
        width = 64,
        height = 92,
        variation_count = 2,
  ...
  filling =
  {
    filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-filling.png",
    priority = "extra-high",
    width = 48,
    height = 56,
    variation_count = 8,
  ...
  water_connection_patch =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-patch.png",
        priority = "extra-high",
        width = 116,
        height = 128,
        shift = util.by_pixel(0, -2),
  ...
  gate_connection_patch =
  {
    ...
    {
      {
        filename = "__ImRC-combat__/graphics/entity/t2wall/t2wall-gate.png",
        priority = "extra-high",
        width = 82,
        height = 108,
        shift = util.by_pixel(0, -7),
...
local t2w_remn = table.deepcopy(data.raw["corpse"]["wall-remnants"])
t2w_remn.name = "t2wall-remnants"

local t2w_item = table.deepcopy(data.raw["item"]["stone-wall"])
t2w_item.name = "t2wall"
t2w_item.place_result = "t2wall"
t2w_item.icon = "__ImRC-combat__/graphics/icons/t2wall.png"
...
t2w_tech = {
  type = "technology",
  name = "t2wall",
  icon = "__ImRC-combat__/graphics/technology/t2wall.png",
  icon_size = 256,
  effects =
  {
    {
...
if settings.startup["enable-t2walls"].value then
  ...
  data.raw["wall"]["stone-wall"].next_upgrade = t2w_ent.name
end